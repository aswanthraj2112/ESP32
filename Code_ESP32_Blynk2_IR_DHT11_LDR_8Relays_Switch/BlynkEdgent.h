  ...
  if (irrecv.decode(&results)) {
      switch(results.value){
          ...
          case 0x1FE40BF:  
            ...
            break;
          case 0x1FE48B7:
            digitalWrite(RelayPin1, toggleState_1);delay(100); 
            digitalWrite(RelayPin2, toggleState_2);delay(100); 
            digitalWrite(RelayPin3, toggleState_3);delay(100); 
            digitalWrite(RelayPin4, toggleState_4);delay(100); 
            digitalWrite(RelayPin5, toggleState_5);delay(100); 
            digitalWrite(RelayPin6, toggleState_6);delay(100); 
            digitalWrite(RelayPin8, toggleState_8);delay(100);               
            break;  
          default : break;         
        }   
